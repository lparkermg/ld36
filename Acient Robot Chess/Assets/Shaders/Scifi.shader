...
////// Emissive:
                ...
                float node_1030 = (node_5746.g*_FlashFrequency);
                float4 _EmitTexture_var = tex2D(_EmitTexture,TRANSFORM_TEX(i.uv0, _EmitTexture));
                float3 emissive = ((saturate(sin(lerp( node_1030, 1.0, _AlwaysOn )))*0.5+0.5)*_EmitTexture_var.rgb*_EmitterColour.rgb);
/// Final Color:
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float node_1030 = (node_5746.g*_FlashFrequency);
                float4 _EmitTexture_var = tex2D(_EmitTexture,TRANSFORM_TEX(i.uv0, _EmitTexture));
                o.Emission = ((saturate(sin(lerp( node_1030, 1.0, _AlwaysOn )))*0.5+0.5)*_EmitTexture_var.rgb*_EmitterColour.rgb);
